  ...
  return (
    <main className="relative min-h-screen">
      ...
      <div className='relative z-10 w-full px-6 md:px-0 md:w-10/12 mx-auto'>
        <div className='pb-20 pt-32 md:pt-44 md:pb-20 border-[#F9F9F933] border-b '>
        ...
        <div className='flex flex-col md:flex-row gap-y-6 justify-between items-center pt-5 pb-14'>
          <div className='flex flex-row gap-x-4 md:gap-x-6 justify-center items-center text-[#F9F9F9] text-base md:text-xl uppercase'>
            <p>Amplify</p>
          ...
          <div className="flex flex-row justify-between items-center gap-x-6 md:gap-x-6">
            <button className="px-3 md:px-6 py-3 border border-[#F9F9F980] text-[#F9F9F9] uppercase text-base md:text-xl rounded-sm hover:bg-[#F9F9F910] transition-colors">
              <Link href="https://olivine-cup-272.notion.site/22235754e3678092bf1cd814bba362c2?pvs=105">
                Become a Sponsor
              </Link>
            </button>

            <button className="px-3 md:px-6 py-3 border border-[#F9F9F9] bg-[#F9F9F9] text-black uppercase text-base md:text-xl rounded-sm hover:bg-gray-100 transition-colors">
              <Link href="https://olivine-cup-272.notion.site/21d35754e3678042b13ece1465f15ba6">
                Register
              </Link>
            </button>
          </div>
